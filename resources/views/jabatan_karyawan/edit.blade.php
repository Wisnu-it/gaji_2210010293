                                ...
                                <select name="jabatan_id" class="form-control select2" required>
                                    ...
                                    @foreach ($jabatans as $jabatan)
                                        <option value="{{ $jabatan->id }}"
                                            {{ (old('jabatan_id', $jabatanKaryawan->jabatan_id) == $jabatan->id) ? 'selected' : '' }}>
                                ...
                                <select name="karyawan_id" class="form-control select2" required>
                                    ...
                                    @foreach ($karyawans as $karyawan)
                                        <option value="{{ $karyawan->id }}"
                                            {{ (old('karyawan_id', $jabatanKaryawan->karyawan_id) == $karyawan->id) ? 'selected' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="date" name="tanggal_mulai" class="form-control"
                                       value="{{ old('tanggal_mulai', $jabatanKaryawan->tanggal_mulai) }}" required>
                            </div>
                        </div>

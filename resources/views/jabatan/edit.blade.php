                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('jabatan.update', $jabatan->id) }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" name="gapok_jabatan" step="0.01" min="0" placeholder="Masukkan Gaji Pokok" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input type="number" name="tunjangan_jabatan" step="0.01" min="0" placeholder="Masukkan Tunjangan Jabatan" class="form-control"
                            ...
                            <div class="col-sm-4">
                                <input type="number" name="uang_makan_perhari" step="0.01" min="0" placeholder="Masukkan Uang Makan Perhari" class="form-control"
